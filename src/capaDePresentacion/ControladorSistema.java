...
public class ControladorSistema implements ActionListener, Observer, KeyListener{
	...
	/**
	 * <br>
	 *@param evento: evento que llama desde la vista.
	 *Una vez identificado lo que hay que hacer, se ejecuta la accion.
	 */
	@Override
	public void actionPerformed(ActionEvent evento) {
		...
		if (evento.getActionCommand().equals(InterfazVista.REGISTRAR)) {//registrar en la principal
			...
			this.usuario=null;
			modelo.guardarAgencia(nombreArchivo);
	...
	/**
	 * <br>
	 *Metodo del patron observer/observable una vez recibida la notificacion del objeto que observa, identifica que es lo que
	 *tiene que hacer y ejecuta la vista correspondiente.
	 */
	@Override
	...
	/**
	 * <br>
	 *Metodo que de acuerdo al tipo que usuario que inicio sesion muestra su vista correspondiente.
	 */
