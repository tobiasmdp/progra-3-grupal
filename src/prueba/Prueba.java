...
public class Prueba {
	...
	public static void main(String[] args) {
		 ...
		 */
		empleado1.nuevoTicket(new GregorianCalendar(), new Formulario("Home Office", "HastaV1", "CargaExtendida", "Senior", "Menosde40", "ExperienciaNada", "Primario"));
		/**
		...
		empleado3.nuevoTicket(new GregorianCalendar(), 
				new Formulario("Indistinto", "HastaV1", "CargaMedia", "senior", "masde50", "ExperienciaMedia", "primario"));
		...
		empleador1.nuevoTicket(new GregorianCalendar(), 
				new Formulario("Indistinto", "HastaV1", "CargaMedia", "Managment", "masde50", "ExperienciaMedia", "secundario"),"activo",1,1,3,4,5,6,7,8);
